...
boxbots/worlds/Arena_World) los cuales estan compuestos por objetos moviles e inmoviles, en el caso de Race.xml, define un pequeño camino de obstaculos con muros paralelos y modelos abiertos provistos por gazebos.
![Race Environment](./image/Race_Environment_Screenshot.png)

El otro entorno, denominado Arena.xml es un pequeño "ring" con juegos para multiples robots, nuevamente compuesto de muros, rampas y modelos 
abiertos de Gazebo.
![Arena Environment](./image/Arena_Environment_Screenshot.png)
